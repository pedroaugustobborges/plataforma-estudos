...
- Laboratório credenciado
        ...
        flashcards: [
          ...
          {
            id: 'ce-fc-16-7',
            frente: 'Qual a Portaria federal que estabelece o padrão de potabilidade da água?',
            verso: '**Portaria GM/MS nº 888/2021**\n\nEstabelece os padrões de potabilidade:\n- Parâmetros microbiológicos\n- Parâmetros químicos\n- Parâmetros físicos\n- Frequência de análises\n\nÉ a norma federal que a Portaria SES-GO 2145/2024 referencia.',
          ...
          {
            id: 'ce-fc-16-8',
            frente: 'O que um fiscal deve verificar em inspeção de sistema de abastecimento de água?',
            verso: '**Itens de verificação:**\n\n1. **Licença sanitária** - vigente\n2. **RT** - presente e habilitado\n3. **Análises** - frequência e resultados\n4. **Tratamento** - funcionamento adequado\n5. **Cloro residual** - 0,2 a 5,0 mg/L\n6. **Registros** - documentação atualizada\n7. **VIGIAGUA** - cadastro no sistema',
            tags: ['fiscalização', 'inspeção'],
            dificuldade: 'medio',
            caixa: 1,
            proximaRevisao: null,
            ultimaRevisao: null,
        ...
        questoes: [
          ...
          {
            id: 'ce-q-16-7',
            enunciado: 'A Solução Alternativa Individual (SAI) para abastecimento de água:',
            alternativas: [
              { letra: 'A', texto: 'exige licenciamento sanitário obrigatório.' },
              { letra: 'B', texto: 'atende a múltiplas famílias.' },
              { letra: 'C', texto: 'dispensa licenciamento sanitário.' },
              { letra: 'D', texto: 'possui rede de distribuição.' },
              { letra: 'E', texto: 'é coordenada pelo VIGIAGUA.' },
            ],
            gabarito: 'C',
          ...
          {
            id: 'ce-q-16-8',
            enunciado: 'A Portaria GM/MS nº 888/2021 estabelece:',
            alternativas: [
              { letra: 'A', texto: 'normas de licenciamento de estabelecimentos.' },
              { letra: 'B', texto: 'padrões de potabilidade da água para consumo humano.' },
              { letra: 'C', texto: 'regras para transporte de alimentos.' },
              { letra: 'D', texto: 'procedimentos de vigilância epidemiológica.' },
              { letra: 'E', texto: 'normas de descarte de resíduos.' },
            ],
            gabarito: 'B',
          ...
          {
            id: 'ce-q-16-9',
            enunciado: 'O valor MÁXIMO permitido de cloro residual livre na água para consumo humano é:',
            alternativas: [
              { letra: 'A', texto: '0,2 mg/L.' },
              { letra: 'B', texto: '1,0 mg/L.' },
              { letra: 'C', texto: '2,0 mg/L.' },
              { letra: 'D', texto: '5,0 mg/L.' },
              { letra: 'E', texto: '10,0 mg/L.' },
            ],
            gabarito: 'D',
          ...
          {
            id: 'ce-q-16-10',
            enunciado: 'A Solução Alternativa Coletiva (SAC) caracteriza-se por:',
            alternativas: [
              { letra: 'A', texto: 'possuir rede de distribuição.' },
              { letra: 'B', texto: 'atender apenas uma família.' },
              { letra: 'C', texto: 'ser coletiva e não possuir rede de distribuição.' },
              { letra: 'D', texto: 'dispensar licenciamento sanitário.' },
              { letra: 'E', texto: 'não necessitar de tratamento.' },
            ],
            gabarito: 'C',
...
- Compartilhamento de informações
        ...
        flashcards: [
          ...
          },
          {
            id: 'ce-fc-17-6',
            frente: 'O que é o SINAN?',
            verso: '**SINAN** = Sistema de Informação de Agravos de Notificação\n\n**Funções:**\n- Registro de notificações\n- Investigação de casos\n- Geração de relatórios\n- Análise epidemiológica\n- Monitoramento de indicadores\n\nÉ o sistema do SUS para notificações compulsórias.',
            tags: ['SINAN', 'sistema'],
            dificuldade: 'facil',
            caixa: 1,
            proximaRevisao: null,
          ...
          {
            id: 'ce-fc-17-7',
            frente: 'Qual a diferença entre CAT e notificação no SINAN?',
            verso: '**CAT** (Comunicação de Acidente de Trabalho):\n→ Destinatário: INSS (Previdência)\n→ Finalidade: benefícios previdenciários\n→ Foco: segurados do INSS\n\n**SINAN:**\n→ Destinatário: SUS (Vigilância)\n→ Finalidade: vigilância epidemiológica\n→ Foco: todos trabalhadores\n\nSão documentos COMPLEMENTARES, não substitutos!',
            tags: ['CAT', 'SINAN', 'diferença'],
            dificuldade: 'dificil',
            caixa: 1,
            proximaRevisao: null,
            ultimaRevisao: null,
          ...
          {
            id: 'ce-fc-17-8',
            frente: 'O que é o CEREST e qual sua relação com as notificações?',
            verso: '**CEREST** = Centro de Referência em Saúde do Trabalhador\n\n**Funções:**\n- Referência técnica para notificações\n- Apoio diagnóstico\n- Investigação de casos\n- Capacitação de profissionais\n- Vigilância em saúde do trabalhador\n\nRecebe e analisa notificações de agravos ocupacionais.',
            tags: ['CEREST', 'referência'],
            dificuldade: 'medio',
            caixa: 1,
            proximaRevisao: null,
            ultimaRevisao: null,
        ...
        questoes: [
          ...
          {
            id: 'ce-q-17-6',
            enunciado: 'A LER/DORT é:',
            alternativas: [
              { letra: 'A', texto: 'doença não relacionada ao trabalho.' },
              { letra: 'B', texto: 'agravo de notificação compulsória.' },
              { letra: 'C', texto: 'doença de notificação facultativa.' },
              { letra: 'D', texto: 'lesão que dispensa investigação.' },
              { letra: 'E', texto: 'agravo exclusivo do setor industrial.' },
            ],
            gabarito: 'B',
          ...
          {
            id: 'ce-q-17-7',
            enunciado: 'O CEREST tem como função:',
            alternativas: [
              { letra: 'A', texto: 'conceder benefícios previdenciários.' },
              { letra: 'B', texto: 'ser referência técnica em saúde do trabalhador.' },
              { letra: 'C', texto: 'fiscalizar apenas indústrias.' },
              { letra: 'D', texto: 'substituir a vigilância sanitária.' },
              { letra: 'E', texto: 'emitir a CAT.' },
            ],
            gabarito: 'B',
          ...
          {
            id: 'ce-q-17-8',
            enunciado: 'A intoxicação por agrotóxicos:',
            alternativas: [
              { letra: 'A', texto: 'não é agravo de notificação compulsória.' },
              { letra: 'B', texto: 'só deve ser notificada em casos fatais.' },
              { letra: 'C', texto: 'é agravo de notificação compulsória.' },
              { letra: 'D', texto: 'só ocorre em trabalhadores rurais.' },
              { letra: 'E', texto: 'dispensa investigação epidemiológica.' },
            ],
            gabarito: 'C',
          ...
          {
            id: 'ce-q-17-9',
            enunciado: 'A CAT e a notificação no SINAN:',
            alternativas: [
              { letra: 'A', texto: 'são o mesmo documento.' },
              { letra: 'B', texto: 'são complementares, com finalidades distintas.' },
              { letra: 'C', texto: 'substituem uma à outra.' },
              { letra: 'D', texto: 'são destinadas apenas ao INSS.' },
              { letra: 'E', texto: 'são facultativas.' },
            ],
            gabarito: 'B',
          ...
          {
            id: 'ce-q-17-10',
            enunciado: 'Os transtornos mentais relacionados ao trabalho:',
            alternativas: [
              { letra: 'A', texto: 'não são de notificação compulsória.' },
              { letra: 'B', texto: 'incluem apenas depressão.' },
              { letra: 'C', texto: 'são de notificação compulsória, incluindo Burnout.' },
              { letra: 'D', texto: 'só são notificados após afastamento.' },
              { letra: 'E', texto: 'dispensam investigação.' },
            ],
            gabarito: 'C',
...
- Canais de diálogo
        ...
        flashcards: [
          ...
          {
            id: 'ce-fc-18-7',
            frente: 'Quais são exemplos de condutas que caracterizam assédio moral?',
            verso: '**Isolamento:**\n- Ignorar presença\n- Excluir de reuniões\n\n**Humilhação:**\n- Críticas constantes em público\n- Apelidos pejorativos\n\n**Desqualificação profissional:**\n- Retirar tarefas\n- Atribuir tarefas inferiores\n- Impedir promoção\n- Desconsiderar pareceres\n\n**Pressão excessiva:**\n- Metas impossíveis\n- Prazos irreais',
            tags: ['condutas', 'exemplos'],
            dificuldade: 'medio',
            caixa: 1,
            proximaRevisao: null,
            ultimaRevisao: null,
          ...
          {
            id: 'ce-fc-18-8',
            frente: 'Quais são os direitos do servidor vítima de assédio moral?',
            verso: '**Direitos da vítima:**\n\n1. **Sigilo** - preservação da identidade\n2. **Proteção** - contra retaliações\n3. **Acompanhamento** - apoio psicológico\n4. **Remoção** - se necessário\n5. **Tratamento** - se houver adoecimento\n\nA denúncia pode ser anônima!',
            tags: ['vítima', 'direitos'],
            dificuldade: 'medio',
            caixa: 1,
            proximaRevisao: null,
            ultimaRevisao: null,
        ...
        questoes: [
          ...
          {
            id: 'ce-q-18-7',
            enunciado: 'NÃO caracteriza assédio moral:',
            alternativas: [
              { letra: 'A', texto: 'humilhação reiterada.' },
              { letra: 'B', texto: 'isolamento do servidor.' },
              { letra: 'C', texto: 'exigência de desempenho no exercício do poder diretivo.' },
              { letra: 'D', texto: 'críticas constantes em público.' },
              { letra: 'E', texto: 'atribuição de tarefas humilhantes.' },
            ],
            gabarito: 'C',
          ...
          {
            id: 'ce-q-18-8',
            enunciado: 'A denúncia de assédio moral na Administração estadual de Goiás:',
            alternativas: [
              { letra: 'A', texto: 'deve ser identificada obrigatoriamente.' },
              { letra: 'B', texto: 'pode ser anônima.' },
              { letra: 'C', texto: 'só pode ser feita pela vítima.' },
              { letra: 'D', texto: 'deve ser feita em cartório.' },
              { letra: 'E', texto: 'não gera proteção ao denunciante.' },
            ],
            gabarito: 'B',
          ...
          {
            id: 'ce-q-18-9',
            enunciado: 'O assédio moral vertical ascendente caracteriza-se por:',
            alternativas: [
              { letra: 'A', texto: 'superior que assedia subordinado.' },
              { letra: 'B', texto: 'subordinado que assedia superior.' },
              { letra: 'C', texto: 'colegas do mesmo nível que se assediam.' },
              { letra: 'D', texto: 'empresa que assedia funcionários.' },
              { letra: 'E', texto: 'cliente que assedia servidor.' },
            ],
            gabarito: 'B',
          ...
          {
            id: 'ce-q-18-10',
            enunciado: 'Em caso de reincidência na prática de assédio moral, a penalidade aplicável é:',
            alternativas: [
              { letra: 'A', texto: 'advertência verbal.' },
              { letra: 'B', texto: 'advertência por escrito.' },
              { letra: 'C', texto: 'suspensão de até 30 dias.' },
              { letra: 'D', texto: 'demissão imediata.' },
              { letra: 'E', texto: 'multa pecuniária.' },
            ],
            gabarito: 'C',
